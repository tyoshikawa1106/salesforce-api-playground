...
| GitHub | `.github`、`docs/setup/github.md` | Issue、PR、branch、CI、merge、Project、milestone の扱いを書く |
...
| セットアップ | `docs/setup` | ローカル環境、外部サービス設定、GitHub Flow、CI、手動確認を書く |
...
| `docs/setup/` | ローカル開発、外部サービス設定、GitHub Flow、PR、CI、手動確認手順 |
...
| `docs/setup/github.md` | GitHub | Issue、PR、branch、label、milestone、Project の方針を書く |
| `docs/setup/ci.md` | CI | docs-only / full check と確認コマンドを書く |
...
| `docs/index.md` | repository guide、API、UI、setup、deployment、knowledge への入口 |
...
| `docs/setup/github.md` | GitHub Flow、Issue / PR、CI、merge、release、Project |
| `docs/setup/ci.md` | docs-only と full check、各コマンドの意味 |
...
- [ ] `docs/repository-guide.md` と `docs/setup` を作った。
