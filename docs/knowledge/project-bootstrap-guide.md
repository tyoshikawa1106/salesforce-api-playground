...
| ドキュメント | README、docs、運用ルール、設計判断メモの分担 |
...
| GitHub 運用 | `.github`、`docs/operations/github.md` | Issue、PR、branch、CI、merge、Project、milestone の扱いを書く |
...
| 設計情報 | `docs/architecture` | システム構成、責務境界、ディレクトリ、主要フローを書く |
| セットアップ | `docs/setup` | ローカル環境、外部サービス設定、手動確認を書く |
| セキュリティ | `docs/security` | 個人情報、機密情報、秘密情報、token、Cookie、ログの扱いを書く |
| 運用 | `docs/operations` | CI、開発チェックリスト、障害対応、デプロイ判断を書く |
| ナレッジ | `docs/knowledge` | 学習内容、比較、次回以降に再利用する知見を書く |
| 判断メモ | `docs/decisions` | 採用した技術や運用判断と見直し条件を書く |
...
| `docs/architecture/system-overview.md` | システム概要 | 主要コンポーネント、データフロー、責務境界を書く |
| `docs/architecture/directory-structure.md` | ディレクトリ説明 | 主要ディレクトリの責務と置かないものを書く |
| `docs/setup/local-development.md` | ローカル開発 | 必要環境、環境変数、起動、確認コマンドを書く |
| `docs/security/auth-and-secrets.md` | 認証と秘密情報 | token、secret、Cookie、ログ、個人情報の扱いを書く |
| `docs/operations/github.md` | GitHub 運用 | Issue、PR、branch、label、milestone、Project の方針を書く |
| `docs/operations/ci.md` | CI | docs-only / full check と確認コマンドを書く |
| `docs/operations/development-checklist.md` | 開発チェックリスト | 作業開始、変更前確認、変更後確認、PR 前確認を書く |
| `docs/knowledge/README.md` | 個人ナレッジ入口 | 学習メモや再利用ナレッジの分類を置く |
| `docs/decisions/README.md` | 設計判断メモ入口 | ADR を追加する場所として用意する |
...
| 再利用しやすい | docs のカテゴリ構成 | architecture、setup、security、operations、knowledge、decisions の分担を使う |
...
| 持ち込まない | 既存 docs の固有説明や判断メモ | 新規アプリで確認できる内容だけを書く |
...
| `docs/index.md` | architecture、setup、security、operations、knowledge、decisions への入口 |
| `docs/architecture/system-overview.md` | アプリの主要構成、外部サービス連携、データフロー |
| `docs/architecture/directory-structure.md` | 各ディレクトリの責務、置かないもの、配置判断 |
| `docs/setup/local-development.md` | Node.js / npm version、install、env、dev server、確認コマンド |
| `docs/security/auth-and-secrets.md` | secret、個人情報、ログ、Cookie、CSRF、外部 token の扱い |
| `docs/operations/github.md` | GitHub Flow、Issue / PR、CI、merge、release、Project |
| `docs/operations/ci.md` | docs-only と full check、各コマンドの意味 |
| `docs/operations/development-checklist.md` | 作業開始時、変更前、変更後、PR 前の確認 |
| `docs/decisions/README.md` | 設計判断メモの書き方と追加場所 |
...
| `docs/operations/*.md` | GitHub、CI、デプロイ、困ったとき |
