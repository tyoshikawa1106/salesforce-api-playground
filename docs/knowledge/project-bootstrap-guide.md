...
| GitHub | `.github`、`docs/operations/github.md` | Issue、PR、branch、CI、merge、Project、milestone の扱いを書く |
...
| 運用 | `docs/operations` | GitHub、CI、障害対応、デプロイ判断を書く |
...
| `docs/operations/github.md` | GitHub | Issue、PR、branch、label、milestone、Project の方針を書く |
