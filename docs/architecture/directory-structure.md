...
| `docs` | 開発者向け一次情報 | 設計、API、セットアップ、運用、デプロイ、セキュリティ、個人ナレッジ、設計判断メモ | GitHub Releases として管理すべき正式なリリースノート |
...
| `docs/knowledge` | 開発手法、概念理解、比較、学習内容などの個人ナレッジ |
