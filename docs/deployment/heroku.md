...
Heroku 自動デプロイの画面設定手順は未確認です。現状の運用では、Heroku release の説明に GitHub merge commit と対応する commit hash が記録される前提で確認します。
...
2. CI は `.github/workflows/ci.yml` に基づき、Node.js 20 / 22 で以下を実行する。
