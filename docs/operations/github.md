...
| `Freeze legacy branches` | `refs/heads/develop`, `refs/heads/release/*`, `refs/heads/hotfix/*` | 新規開発の base として使わない。必要に応じて deletion 禁止、non-fast-forward 禁止、または作成制限を設定する | なし |
