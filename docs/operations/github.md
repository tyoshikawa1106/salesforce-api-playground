...
Project 自動追加の実効状態は、workflow 全体の conclusion だけで判断しません。secret 未設定時も workflow は success になり、Project 追加 step だけが skipped になります。必要に応じて対象 run の job / step 結果を確認します。
