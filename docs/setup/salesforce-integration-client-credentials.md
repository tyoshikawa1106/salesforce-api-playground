...
Client ID、Client Secret、`SALESFORCE_INTEGRATION_LOGIN_URL` を変更した直後は、先に [Salesforce 認証疎通確認方法](salesforce-manual-verification.md#salesforce-認証疎通確認方法) を実行し、Salesforce の業務データを作成、更新せずに Client Credentials Flow の認証が通ることを確認します。
