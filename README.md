...
詳細は [システム概要](docs/architecture/system-overview.md) を参照してください。GitHub Pages 有効化後は [ドキュメントサイト](https://tyoshikawa1106.github.io/salesforce-api-playground/) からも参照できます。
...
`INTEGRATION_API_KEY` は `/api/integration/*` 呼び出し元をこのアプリ側で検証するための共有鍵です。
...
GitHub Pages 有効化後は [ドキュメントサイト](https://tyoshikawa1106.github.io/salesforce-api-playground/) から参照できます。
